  ...
  return (
    <div className="mt-[4.5rem] sm:mt-[4.7rem] md:mt-[5rem] p-[2rem]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 mt-[2rem]">
        <div className="text-center rounded-lg p-[3rem] bg-gray-100">
          <div className="text-[2rem] font-bold text-teal-700">34+</div>
          <img
            src="/experience.png"
            alt=""
        ...
        <div className="text-center  p-[3rem] bg-gray-100 rounded-lg">
          {" "}
          <div className="text-[2rem] font-bold text-teal-700">34+</div>
          <img
            src="/experience.png"
